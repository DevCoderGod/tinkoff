...
export interface OrderTrade {
     ...
     */
    quantity: string; // Количество штук в сделке.
    /**
...
export interface PostOrderResponse {
     ...
     */
    lotsExecuted: string; // Исполнено лотов.
    /**
...
class OrderTrade$Type extends MessageType<OrderTrade> {
    ...
    create(value?: PartialMessage<OrderTrade>): OrderTrade {
        const message = { quantity: "0", tradeId: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class PostOrderRequest$Type extends MessageType<PostOrderRequest> {
    ...
    create(value?: PartialMessage<PostOrderRequest>): PostOrderRequest {
        const message = { figi: "", quantity: "0", direction: 0, accountId: "", orderType: 0, orderId: "", instrumentId: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class PostOrderResponse$Type extends MessageType<PostOrderResponse> {
    constructor() {
        super("tinkoff.public.invest.api.contract.v1.PostOrderResponse", [
            ...
            { no: 3, name: "lots_requested", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            { no: 4, name: "lots_executed", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
    ...
    create(value?: PartialMessage<PostOrderResponse>): PostOrderResponse {
        const message = { orderId: "", executionReportStatus: 0, lotsRequested: "0", lotsExecuted: "0", figi: "", direction: 0, orderType: 0, message: "", instrumentUid: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 lots_executed */ 4:
                    message.lotsExecuted = reader.int64().toString();
                    break;
...
class OrderState$Type extends MessageType<OrderState> {
    ...
    create(value?: PartialMessage<OrderState>): OrderState {
        const message = { orderId: "", executionReportStatus: 0, lotsRequested: "0", lotsExecuted: "0", figi: "", direction: 0, stages: [], currency: "", orderType: 0, instrumentUid: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class ReplaceOrderRequest$Type extends MessageType<ReplaceOrderRequest> {
    ...
    create(value?: PartialMessage<ReplaceOrderRequest>): ReplaceOrderRequest {
        const message = { accountId: "", orderId: "", idempotencyKey: "", quantity: "0", priceType: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
