...
import type { GetTradingStatusesResponse } from "./marketdata.js";
import type { GetTradingStatusesRequest } from "./marketdata.js";
...
export class MarketDataServiceClient implements IMarketDataServiceClient, ServiceInfo {
    ...
    getTradingStatuses(input: GetTradingStatusesRequest, options?: RpcOptions): UnaryCall<GetTradingStatusesRequest, GetTradingStatusesResponse> {
        ...
        return stackIntercept<GetTradingStatusesRequest, GetTradingStatusesResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Метод запроса обезличенных сделок за последний час.
     *
