...
import { InstrumentType } from "./common.js";
...
export interface Operation {
     ...
     */
    quantity: string; // Количество единиц инструмента.
    /**
     * @generated from protobuf field: int64 quantity_rest = 8;
     */
    quantityRest: string; // Неисполненный остаток по сделке.
    /**
...
export interface OperationTrade {
     ...
     */
    quantity: string; // Количество инструментов.
    /**
...
export interface PortfolioPosition {
     ...
     */
    blockedLots?: Quotation; // Количество бумаг, заблокированных выставленными заявками.
    /**
...
export interface PositionsSecurities {
     ...
     */
    blocked: string; // Количество бумаг заблокированных выставленными заявками.
    /**
     * @generated from protobuf field: int64 balance = 3;
     */
    balance: string; // Текущий незаблокированный баланс.
    /**
...
export interface DividendsForeignIssuerReport {
     ...
     */
    quantity: string; // Количество ценных бумаг.
    /**
...
export interface OperationItem {
     ...
     */
    quantityDone: string; // Исполненный остаток.
    /**
...
export interface OperationItemTrade {
     ...
     */
    quantity: string; // Количество в единицах.
    /**
...
class Operation$Type extends MessageType<Operation> {
    constructor() {
        super("tinkoff.public.invest.api.contract.v1.Operation", [
            ...
            { no: 8, name: "quantity_rest", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            ...
            { no: 17, name: "position_uid", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 18, name: "instrument_uid", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<Operation>): Operation {
        const message = { id: "", parentOperationId: "", currency: "", state: 0, quantity: "0", quantityRest: "0", figi: "", instrumentType: "", type: "", operationType: 0, trades: [], assetUid: "", positionUid: "", instrumentUid: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 quantity_rest */ 8:
                    message.quantityRest = reader.int64().toString();
                    break;
                case /* string figi */ 9:
                    message.figi = reader.string();
                    break;
                ...
                case /* string asset_uid */ 16:
                    ...
                    break;
                case /* string position_uid */ 17:
                    message.positionUid = reader.string();
                    break;
                case /* string instrument_uid */ 18:
    ...
    internalBinaryWrite(message: Operation, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.positionUid !== "")
            writer.tag(17, WireType.LengthDelimited).string(message.positionUid);
        /* string instrument_uid = 18; */
        if (message.instrumentUid !== "")
            writer.tag(18, WireType.LengthDelimited).string(message.instrumentUid);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class PortfolioPosition$Type extends MessageType<PortfolioPosition> {
    constructor() {
        super("tinkoff.public.invest.api.contract.v1.PortfolioPosition", [
            ...
            { no: 22, name: "blocked_lots", kind: "message", T: () => Quotation },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool blocked */ 21:
                    ...
                    break;
                case /* tinkoff.public.invest.api.contract.v1.Quotation blocked_lots */ 22:
                    message.blockedLots = Quotation.internalBinaryRead(reader, reader.uint32(), options, message.blockedLots);
                    break;
    ...
    internalBinaryWrite(message: PortfolioPosition, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.blockedLots)
            Quotation.internalBinaryWrite(message.blockedLots, writer.tag(22, WireType.LengthDelimited).fork(), options).join();
...
class PositionsSecurities$Type extends MessageType<PositionsSecurities> {
    constructor() {
        super("tinkoff.public.invest.api.contract.v1.PositionsSecurities", [
            { no: 1, name: "figi", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "blocked", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
    ...
    create(value?: PartialMessage<PositionsSecurities>): PositionsSecurities {
        const message = { figi: "", blocked: "0", balance: "0", positionUid: "", instrumentUid: "", exchangeBlocked: false, instrumentType: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 blocked */ 2:
                    message.blocked = reader.int64().toString();
                    break;
...
class PositionsFutures$Type extends MessageType<PositionsFutures> {
    ...
    create(value?: PartialMessage<PositionsFutures>): PositionsFutures {
        const message = { figi: "", blocked: "0", balance: "0", positionUid: "", instrumentUid: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class PositionsOptions$Type extends MessageType<PositionsOptions> {
    constructor() {
        super("tinkoff.public.invest.api.contract.v1.PositionsOptions", [
            { no: 1, name: "position_uid", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "instrument_uid", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 11, name: "blocked", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            { no: 21, name: "balance", kind: "scalar", T: 3 /*ScalarType.INT64*/ }
        ]);
    }
    create(value?: PartialMessage<PositionsOptions>): PositionsOptions {
        const message = { positionUid: "", instrumentUid: "", blocked: "0", balance: "0" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class BrokerReport$Type extends MessageType<BrokerReport> {
    ...
    create(value?: PartialMessage<BrokerReport>): BrokerReport {
        const message = { tradeId: "", orderId: "", figi: "", executeSign: "", exchange: "", classCode: "", direction: "", name: "", ticker: "", quantity: "0", party: "", brokerStatus: "", separateAgreementType: "", separateAgreementNumber: "", separateAgreementDate: "", deliveryType: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class DividendsForeignIssuerReport$Type extends MessageType<DividendsForeignIssuerReport> {
    ...
    create(value?: PartialMessage<DividendsForeignIssuerReport>): DividendsForeignIssuerReport {
        const message = { securityName: "", isin: "", issuerCountry: "", quantity: "0", currency: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class OperationItem$Type extends MessageType<OperationItem> {
    constructor() {
        super("tinkoff.public.invest.api.contract.v1.OperationItem", [
            ...
            { no: 51, name: "quantity", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            { no: 52, name: "quantity_rest", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
            { no: 53, name: "quantity_done", kind: "scalar", T: 3 /*ScalarType.INT64*/ },
    ...
    create(value?: PartialMessage<OperationItem>): OperationItem {
        const message = { cursor: "", brokerAccountId: "", id: "", parentOperationId: "", name: "", type: 0, description: "", state: 0, instrumentUid: "", figi: "", instrumentType: "", instrumentKind: 0, positionUid: "", quantity: "0", quantityRest: "0", quantityDone: "0", cancelReason: "", assetUid: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 quantity_done */ 53:
                    message.quantityDone = reader.int64().toString();
                    break;
